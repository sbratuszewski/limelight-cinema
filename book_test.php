        ...
        <div class="container form-cms mb-5">
            <div class="row  py-5">
                ...
                <div class="admin-content col-6">
                    ...
                    <form action="includes/bookingConfirm.php" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <select name="movie" class="form-control" id="exampleFormControlSelect1">
                                ...
                                <option>Birdman</option>
                                <option>Man Bites Dog</option>
...
<?php require_once('footer.php');
    ...
    header('location: index?error=You need to log in first to purchase a ticket!');
} ?>